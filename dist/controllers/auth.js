...
export async function signup(req, res, next) {
    ...
    try {
        ...
        const loginToken = jwt.sign({ username: req.body.username }, jwtSecret, { expiresIn: '1d' });
        res.status(201).json({
...
export async function loginAsUser(req, res, next) {
    try {
...
export async function deleteLoggedInUser(req, res, next) {
    try {
