 ...
 * @returns {number}
 */
export function randFromBounds(bounds) { return randRange(bounds[0], bounds[1]); }
/**
 ...
 */
export function randomIndicesNoReplacement(n, k) {
    if (n < k) {
        return null;
    }
