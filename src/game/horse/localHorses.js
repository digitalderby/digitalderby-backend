...
exports.createRace = exports.generateLocalHorsesFromSpecs = exports.loadHorsesFromDatabase = exports.localHorses = void 0;
...
var purge_js_1 = require("../../purge.js");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    horseSpecs = _a.sent();
                    if (!(horseSpecs.length !== globalsettings_js_1.HORSE_POPULATION)) return [3 /*break*/, 4];
                    console.log('Not enough horses in database; regenerating them.');
                    // Delete all horses already in the database first
                    return [4 /*yield*/, (0, purge_js_1.default)()];
                case 2:
                    // Delete all horses already in the database first
                    _a.sent();
                    horses = (0, Horse_js_1.generateNewHorses)().map(function (h) { return new Horse_js_1.Horse(h); });
...
function createRace() {
    ...
    var indices = (0, random_js_1.randomIndicesNoReplacement)(globalsettings_js_1.HORSE_POPULATION, globalsettings_js_1.HORSES_PER_RACE);
    if (indices === null) {
        return null;
    }
