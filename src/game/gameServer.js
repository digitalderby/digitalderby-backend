...
exports.GameServer = exports.RESULTS_DELAY = exports.PRERACE_DELAY = exports.BETTING_DELAY = exports.SERVER_TICK_RATE_MS = void 0;
...
console.log("Betting delay: ".concat(exports.BETTING_DELAY));
console.log("Pre-race delay: ".concat(exports.PRERACE_DELAY));
console.log("Results delay: ".concat(exports.RESULTS_DELAY));
...
var GameServer = /** @class */ (function () {
    ...
    GameServer.prototype.createServer = function (server) {
        ...
        // event listeners.
        this.io.of('/user').use(function (socket, next) { return (_this.closedMiddleware(socket, next)); });
        this.io.of('/user').use(function (socket, next) { return (_this.authMiddleware(socket, next)); });
    ...
    GameServer.prototype.closedMiddleware = function (socket, next) {
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        token = ((_a = socket.handshake.auth) === null || _a === void 0 ? void 0 : _a.token) ||
                            ((_b = socket.handshake.headers) === null || _b === void 0 ? void 0 : _b.token);
                        if (token === undefined) {
    ...
    GameServer.prototype.userHandler = function (socket) {
        ...
        socket.on('bet', function (_a, res) {
            ...
            if (currentBet !== undefined) {
                ...
                _this.pool[currentBet.horseIdx] -= currentBet.betValue;
            }
    ...
    GameServer.prototype.startBettingMode = function () {
        ...
        this.raceStates = null;
        this.bets = new Map();
        this.pool = Array(localHorses_js_1.HORSES_PER_RACE).fill(0);
        this.totalPool = 0;
    };
    GameServer.prototype.startRaceMode = function () {
        ...
        for (var i = 0; i < localHorses_js_1.HORSES_PER_RACE; i++) {
        ...
        this.raceStates[0].horseStates[0].position = race_js_1.RACE_DURATION - 1;
    };
    GameServer.prototype.startResultsMode = function () {
        ...
        for (var _i = 0, _a = this.bets.values(); _i < _a.length; _i++) {
            ...
            console.log("Player ".concat(bet.username, " ").concat((bet.returns > 0) ? 'receives' : 'loses', " ").concat(Math.abs(bet.returns), " from their bet on horse ").concat(bet.horseIdx + 1));
        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        // log's id
                        return [4 /*yield*/, Promise.all(__spreadArray([], this.bets.values(), true).map(function (bet) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, bet.commit(game._id)];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
    ...
    GameServer.prototype.startMainLoop = function () {
        ...
        this.prevTime = (0, time_js_1.hrTimeMs)();
        var cancel = false;
        this._loopCancelFunction = function () { cancel = true; };
