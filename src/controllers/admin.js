...
exports.purgeHorses = exports.closeRaceServer = exports.openRaceServer = exports.getServerStatus = void 0;
...
function purgeHorses(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var horses, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.purgeHorses = purgeHorses;
