...
exports.createNewHorses = exports.toggleAutostart = exports.startRaceAndAutostart = exports.startRaceLoop = exports.stopRaceServer = exports.startRaceServer = exports.getServerStatus = exports.getServerSettings = exports.loginAsAdmin = void 0;
...
function startRaceServer(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            gameServer_js_1.default.createServer(app_js_1.server);
            res.status(200).json({ message: 'Server is now active' });
            return [2 /*return*/];
        });
    });
}
exports.startRaceServer = startRaceServer;
function stopRaceServer(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
exports.stopRaceServer = stopRaceServer;
