    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, User_js_1.User.find({}, "username").lean()];
                case 1:
                    usernames = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, User_js_1.User.findOne({ username: req.params.uname }, "-passwordHash")];
                case 1:
                    user = _a.sent();
                    if (!user) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    userData = req.body;
                    newUser = new User_js_1.User(userData);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, User_js_1.User.findByIdAndUpdate(userIdToUpdate, updatedUserData, { new: true })];
                case 1:
                    updatedUser = _a.sent();
...
function deleteUser(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var usernameToDelete, user, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    usernameToDelete = req.params.uname;
                    return [4 /*yield*/, User_js_1.User.findOne({ username: usernameToDelete })];
                case 1:
                    user = _a.sent();
                    // If user does not exist, return 404 Not Found
                    if (!user) {
                        return [2 /*return*/, (0, errorHandler_js_1.sendJSONError)(res, 404, "User ".concat(usernameToDelete, " not found"))];
                    }
                    // Delete the user
                    return [4 /*yield*/, User_js_1.User.deleteOne({ _id: usernameToDelete })];
                case 2:
                    // Delete the user
                    _a.sent();
                    // Return success message
                    res.status(200).json({
                        message: "User ".concat(usernameToDelete, " has been deleted successfully"),
                    });
                    return [3 /*break*/, 4];
                case 3:
                    error_5 = _a.sent();
