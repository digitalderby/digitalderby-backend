...
router.post('/startRaceServer', authentication_js_1.loggedInAsAdmin, admin_js_1.startRaceServer);
router.post('/stopRaceServer', authentication_js_1.loggedInAsAdmin, admin_js_1.stopRaceServer);
